...
namespace Decorator.CustomStringBulder
{

    // Expose API of StringBuilder, and we can add functionality.
    // StringBuilder is sealed class, so we can't inherit from it.
     public class Demo
    {
